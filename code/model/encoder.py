...
class RNNEncoder(nn.Module):
    ...
    def forward(self, ids, lengths, word_embeddings, hidden, pass_embedds=False):
        ...
        # print("EMBEDDINGS TENSOR SIZE: ",passembeddings,passembeddings.requires_grad)
        # print("EMBEDDINGS ENCODER: ",word_embeddings.weight.requires_grad)
        if is_varlen:
        ...
        if not pass_embedds:
            ...
            return hidden,output,passembeddings

    def initial_hidden(self, batch_size):
        return torch.zeros(self.layers*self.directions, batch_size, self.hidden_size)